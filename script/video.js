...
//1 - Fetch,Load show Catagories on html
...
//aita console teke copy-object kora hoisa 
// const cardDemo= {
...
const displayVideos = (videos) => {
    ...
    <img
      ...
      alt="Shoes" />
        ...
        ${
            ...
            ? ""
            : `<span class = "absolute right-2 text-xs bottom-2 bg-black text-white rounded p-1">
           ${getTimeString(
  ...
  <div class="px-0 py-2 flex gap-2">
    ...
    ${
        ...
        <p> <button onclick = "loadDetails('${video.video_id}')" class = 
        "btn btn-sm btn-error">details</button></p>
    </div>
